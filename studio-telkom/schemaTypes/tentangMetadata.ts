export default {
  name: 'tentangMetadata',
  title: 'Tentang Metadata',
  type: 'document',
  __experimental_actions: ['update', 'publish'],
  fields: [
    { name: 'title', title: 'Title', type: 'string', description: 'Main title for the Tentang page (SEO title)' },
    { name: 'description', title: 'Description', type: 'text', description: 'Meta description for the Tentang page' },
