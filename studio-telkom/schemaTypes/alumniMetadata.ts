export default {
  name: 'alumniMetadata',
  title: 'Alumni Metadata',
  type: 'document',
  __experimental_actions: ['update', 'publish'],
  fields: [
    { name: 'title', title: 'Title', type: 'string', description: 'Main title for the Alumni page (SEO title)' },
    { name: 'description', title: 'Description', type: 'text', description: 'Meta description for the Alumni page' },
