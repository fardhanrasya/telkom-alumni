export default {
  name: 'acaraMetadata',
  title: 'Acara Metadata',
  type: 'document',
  __experimental_actions: ['update', 'publish'],
  fields: [
    { name: 'title', title: 'Title', type: 'string', description: 'Main title for the Acara page (SEO title)' },
    { name: 'description', title: 'Description', type: 'text', description: 'Meta description for the Acara page' },
