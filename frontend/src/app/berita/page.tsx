...
const BeritaContent = () => {
  ...
  const fetchNews = async (page: number, filters: { searchTerm?: string; tag?: string; year?: string; }) => {
    setLoading(true);
    try {
  ...
  const updateURLWithFilters = (filters: { page: number; search?: string; tag?: string; year?: string }) => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 rounded-xl bg-gradient-to-br from-white to-gray-50 p-6 shadow-md border border-gray-100">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            ...
            {/* Filter Tag */}
            <div>
              <label htmlFor="tag" className="mb-2 block text-sm font-semibold text-gray-700">
                Kategori
              </label>
              <select
                id="tag"
