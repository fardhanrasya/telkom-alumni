...
export async function GET(request: Request) {
  ...
  try {
    ...
    // Buat query untuk menghitung total (hanya alumni dengan agreement = true)
    ...
    // Buat query untuk mengambil data dengan pagination (hanya alumni dengan agreement = true)
    const alumniQuery = `*[
      _type == "alumni"
      && defined(slug.current)
      && agreement == true
