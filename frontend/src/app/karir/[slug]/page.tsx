...
interface JobDetail {
  ...
  salaryRange?: string | { min?: number; max?: number; currency?: string; isPublic?: boolean };
  description: any;
  requirements?: any;
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${job.title} di ${typeof job.company === 'string' ? job.company : job.company.name} | Karir Alumni Telkom`,
    description: `Lowongan kerja ${job.title} di ${typeof job.company === 'string' ? job.company : job.company.name}. ${job.jobType}, ${job.workplaceType}.`,
  };
}
  ...
  return (
    <div className="bg-gray-50 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <a href="/karir" className="inline-flex items-center text-sm font-medium text-primary hover:text-primary-dark">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-lg text-gray-600">{typeof job.company === 'string' ? job.company : job.company.name}</p>
                </div>
              </div>
          ...
          <div className="px-4 py-5 sm:p-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="col-span-2">
                <div className="mb-8">
                  <h2 className="text-lg font-medium text-gray-900">Deskripsi Pekerjaan</h2>
                ...
                {job.responsibilities && (
                  <div className="mb-8">
                    <h2 className="text-lg font-medium text-gray-900">Tanggung Jawab</h2>
                    <div className="mt-4 prose prose-blue max-w-none text-gray-900">
                ...
                {job.requirements && (
                  <div className="mb-8">
                    <h2 className="text-lg font-medium text-gray-900">Persyaratan</h2>
                    <div className="mt-4 prose prose-blue max-w-none text-gray-900">
              ...
              <div>
                <div className="rounded-lg bg-gray-50 p-6">
                  ...
                  <dl className="mt-4 space-y-4">
                    ...
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Lokasi Kerja</dt>
                      <dd className="mt-1 text-sm text-gray-900">{job.workplaceType}</dd>
                    </div>
                    
                    {job.salaryRange && typeof job.salaryRange !== 'string' && 
                     (job.salaryRange.isPublic === true || job.salaryRange.isPublic === undefined) && (
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Kisaran Gaji</dt>
                    ...
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Tanggal Publikasi</dt>
                      <dd className="mt-1 text-sm text-gray-900">{formatDate(job.publishedAt)}</dd>
                    </div>
                    
                    {job.expiresAt && (
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Batas Akhir Lamaran</dt>
                    ...
                    {job.contactEmail && (
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Email Kontak</dt>
                        <dd className="mt-1 text-sm text-gray-900">
                          <a href={`mailto:${job.contactEmail}`} className="text-primary hover:text-primary-dark">
                            {job.contactEmail}
                          </a>
                        </dd>
                      </div>
                          ...
                          {job.postedBy.profileImageUrl ? (
                            ...
                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200">
                              <span className="text-sm font-medium text-gray-500">
                                {typeof job.postedBy.name === 'string' ? job.postedBy.name.charAt(0) : 'U'}
                              </span>
                            </div>
                          )}
                        </div>
