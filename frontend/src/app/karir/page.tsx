...
const KarirPage = () => {
  ...
  const [selectedWorkplace, setSelectedWorkplace] = useState(workplaceTypeParam || 'Semua');
  ...
  const fetchJobs = async (page: number, filters: { searchTerm?: string; jobType?: string; workplaceType?: string; }) => {
    setLoading(true);
    try {
  ...
  const updateURLWithFilters = (filters: { page: number; search?: string; jobType?: string; workplaceType?: string }) => {
  ...
  useEffect(() => {
    console.log('Komponen di-mount atau URL berubah, mengambil data lowongan...');
    fetchJobs(
  ...
  const handlePageChange = (page: number) => {
    ...
    updateURLWithFilters({
      ...
      workplaceType: lastQuery.workplaceType !== 'Semua' ? lastQuery.workplaceType : undefined
    });
  ...
  const handleSearch = () => {
    ...
    updateURLWithFilters({
      ...
      workplaceType: selectedWorkplace !== 'Semua' ? selectedWorkplace : undefined
    });
    ...
    <div className="bg-gray-50 py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 rounded-lg bg-gradient-to-r from-gray-50 to-white p-6 shadow-md border border-gray-100">
          <h2 className="mb-4 text-lg font-semibold text-gray-900">Cari Lowongan</h2>
        ...
        {loading ? (
          <div className="space-y-4">
            {[...Array(itemsPerPage)].map((_, index) => (
              <div key={index} className="animate-pulse rounded-lg bg-white p-6 shadow-md">
          ...
          <>
            {jobs.length > 0 ? (
              ...
              <div className="rounded-lg bg-white p-8 text-center shadow-md">
                ...
                <h3 className="mt-2 text-lg font-medium text-gray-900">Tidak ada lowongan yang ditemukan</h3>
                <p className="mt-1 text-sm text-gray-500">
                  Coba ubah filter pencarian Anda atau cek kembali nanti untuk lowongan baru.
                </p>
                <div className="mt-6">
