...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    const alumni = await client.fetch(getAlumniBySlugQuery, { slug }, options);
    ...
    console.error("Error fetching alumni metadata:", error);
    return {
      title: "Alumni | Portal Alumni SMK Telkom Jakarta",
      description: "Profil alumni SMK Telkom Jakarta",
    };
  }
}
...
export default function AlumniSlugLayout({ children }: Props) {
  return <>{children}</>;
}
